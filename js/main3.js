...
function init(event){
      ...
      r3.addEventListener('click',
                    function(event){
                       ...
                       console.log(currentRoutValue);
                       console.log(rubicCube.mesh.rotation.x);
                       group.rotation.x = currentRoutValue + rubicCube.mesh.rotation.x;
...
// currentRoutValue = aGroup.rotation.x;
   if(routValue < Math.PI/2 && rout === true){
     ...
     currentRoutValue = aGroup.rotation.x;// ;//)%(2*Math.PI);
...
//currentRoutValue = rubicCube.mesh.rotation.x;
//if(aGroup.rotation.x > 2*Math.PI || aGroup.rotation.x < -2*Math.PI)
